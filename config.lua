...
Config.Strings = {
	...
	CancelFuelingPump = "Pulsa ~g~E ~w~para cancelar",
	CancelFuelingJerryCan = "Pulsa ~g~E ~w~para cancelar",
	NotEnoughCash = "No tienes dinero",
	RefillJerryCan = "Pulsa ~g~E ~w~ para rellenar el bidón por: ",
	NotEnoughCashJerryCan = "No hay suficiente efectivo para rellenar el bidón",
	JerryCanFull = "El bidón esta lleno",
	TotalCost = "Coste",
}

if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Pulsa ~g~E ~w~agarrar un bidón"
